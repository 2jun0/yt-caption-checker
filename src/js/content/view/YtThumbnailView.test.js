...
describe('YtThumbnailView', () => {
  ...
  describe('preconditions', () => {
    it('throw error if thumbnail element is not a tag', () => {
    ...
    it('throw error if thumbnail element doesn\' have thumbnail id', () => {
      const nonThumbnailEl = {
        tagName: 'A',
        id: 'non-thumbnail',
        href: 'https://www.youtube.com/watch?v=123456',
    ...
    it('throw error if thumbnail element doesn\' have href', () => {
      const nonThumbnailEl = {
        tagName: 'A',
        id: 'thumbnail'
      }
